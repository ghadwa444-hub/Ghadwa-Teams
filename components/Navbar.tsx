                ...
                <div className="flex items-center gap-4">
                    ...
                    {isLoggedIn ? (
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                onClick={onOpenAuth}
                                className="bg-[#8B2525] text-white px-5 py-2.5 rounded-full font-bold hover:bg-[#6b1c1c] transition shadow-lg shadow-[#8B2525]/20 text-sm hidden md:flex items-center gap-2"
                            >
